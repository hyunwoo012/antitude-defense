...
const PrototypeDashboard = lazy(() => import("./pages/PrototypeDashboard"));
				...
				<Box>
					<Suspense fallback={<Spinner />}>
						<Routes>
							...
							<Route path="/prototype" element={<PrototypeDashboard />}></Route>

							<Route path="/stocks/:symbol" element={<StockView />}></Route>
							
							<Route path="/prototype/simulator" element={<AgentSimulator />}></Route>
